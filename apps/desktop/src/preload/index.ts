...
const api: IpcApi = {
  ...
  moneySaveBudget: (input) => ipcRenderer.invoke('money-save-budget', input),
  moneyDeleteBudget: (month) => ipcRenderer.invoke('money-delete-budget', month),
  moneyCreatePurchase: (input) => ipcRenderer.invoke('money-create-purchase', input),
  moneyUpdatePurchase: (id, input) => ipcRenderer.invoke('money-update-purchase', id, input),
  moneyDeletePurchase: (id) => ipcRenderer.invoke('money-delete-purchase', id),
